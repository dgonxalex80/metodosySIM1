...
Para las variables cualitativas en escala nominal se recomienda su visualización a traves de una grafica circular o de torta. En ella se observa rapidamente la categoría con más participación (representada por el área que ocupa). En algunos caso puede además de las etiquetas indicar el porcentaje de participación de cada categoría.
...
Este tipo de variables son muy frecuentes en mediciones de psicológia, marketing, salud y en procesos de evaluación. El color ayuda tambien a reforzar el significado de las categorías, empleandose paletas que en algunos casos representan el semaforo (rojo - amarillo - verde).
...
* El gráfico actial se construye a partir de una tabla categoría por sexo. Representa ahora una gráfico de barras pero del sexo por categoría. Cúal de los dos gráficos prefieres? ¿Porqé?
