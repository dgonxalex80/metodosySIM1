...
Empezaremos con el diagrama de tallos y hojas, que aunque no es un gráfico y corresponde a un ordenamiento de los datos, permite visualizar de una forma rápida su forma. Tambien permite ubicar el valor mínimo y el máximo.
...
Para la construcción del histograma se el rango de los datos en intervalos que pueden ser de igual o diferente tamaño, recomendandose que tenga un número de divisiones apropiado ( 7 a 15) que permita resumir los datos.

Aparentemente se puede semejar con un diagra de barras, pues los rectangulos que lo conforman representan frecuencias, indicando que rectangulos más altos estan indicando una mayor frecuencia de datos en su intervalo. 
...
Este diagrama permite visualizar la forma de los datos, su rango y en que parte se concentra la mayoria de los datos. Es útil para establecer comparaciones con modelos de probabilidad teóricos como la distribución normal, unifirme, ji-cuadrado, ....
...
El grafico de lineas es muy utilizado para representar series de tiempo, pudiendo visualizar sus principales caracteristicas como son : tendencia, estacionalidad, ciclicidad y componentes aleatorios
...
Para declarar el tipo de grafico se emplean diferentes geometrias, en este caso se utiliza `geom_point()`
