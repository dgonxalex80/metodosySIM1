...
Figura 1: Tablero vehículo
```{r, echo=FALSE, out.width="100%", fig.align = "center"}
knitr::include_graphics("img/indicadores.png")
```

Imagen tomada de  : [freepik](https://www.freepik.com/free-vector/dashboard-background-with-color-signals_1048637.htm#query=tablero%20de%20auto&position=0&from_view=search&track=ais)
...
El siguiente gráfico de puntos representa los tiempos alcanzados por los participantes por categoría y sexo empleados para recorrer los 10 kilómetros de la competecia.
...
Los deciles correspondeines a los tiempos registrados en la categoría Abierta para hombres se ilustran en la siguiente gráfica con los puntos naranjas. 
...
Los cuartiles son 3 números que dividen la muestra en cuatro partes, cada una con un 25% de los datos. Con estos indicadores se contruye el diagrma de cajas que además de permitir comparar grupos, ayudan en la identificación de datos atípicos
...
La siguiente es la informaciçon de los tiempos correspondientes a la categoría juvenil femenina:
...
La mediana presenta caracteristicas más robustas frente a cambios de los datos extremos que las que pueda presentar la media.
...
Para el caso del grupo juvenil femenino participante en la carrera de La Luz obteniene una mediana de 
...
Supongamos que tenemos dos grupos de participantes que son patrocinados por dos empresas. Se sabe que ambos grupos tienen igual en promedio de edad. Lo que primero se puede piensar es que los dos grupos tienen una composición igual o muy parecida dado que coinciden en el promedio.  Pero no es así, los datos que se presentan a continuación tienen medias de 28,  pero corresponden a grupos diferentes.
