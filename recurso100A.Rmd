...
La importación de los datos es una de las etapas importantes del proceso para el análisis de datos, que depende del formato y la fuente de los que genera los datos. Esta etapa forma parte del ciclo la limpieza de datos o Data Cleansing.
...
<center>
**Figura : 1.5 ** Ciclo de limpieza de datos  <br/>
...
Para guardar el archivo, se recomienda el formarto RDS por ocupar menos espacio.  En este caso se guarda el archivo descargado con el nombre de *Colombia.RDS* en la carpeta *data/*
