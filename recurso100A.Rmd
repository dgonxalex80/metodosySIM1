...
knitr::include_graphics("img/proceso_cd1.png")
```
...
En este caso se genera la ruta "data/Colombia.RDS", como resultado de ejecutar la función anterior y ubicar el archivo a importar.
