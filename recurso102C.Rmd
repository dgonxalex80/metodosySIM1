...
Gráfica  7 : Comparación distribuciones del tiempo hombres carrer La Luz 2022 
```{r, echo=FALSE, out.width="100%", fig.align = "center"}
...
Gráfica  8 : Distribución de los tiempos por categoría carrer La Luz 2022 
```{r, echo=FALSE, out.width="100%", fig.align = "center"}
...
La gráfica permite visulizar que no existe relación entre las variables tiempo de carrera y edad, es decir que en todas las categorias se presentaron corredores con tiempos bajos y tiempos altos.  Tambien permite detectar que un corredor de la categoria Abierta fue el primero en cruzar la meta (33.13 min) y uno de la categoría Veteranos C el último (166.03 min). 
...
En la gráfica se puede observar una tendencia creciente duranto los últimos meses
