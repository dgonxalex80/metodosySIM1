...
Para ilustrar el primer caso tomaremos una muestras pequeñas de la base rotacion contenida en paqueteMET
...
Para ilustrar este caso tomaremos una muestra de la data `rotacion` contenida en `paqueteMET`
