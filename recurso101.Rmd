...
## <span style="color:#034a94">**¿Qué es?**</span>  

</br>

<div class="content-box-blue">
**ESTADÍSTICA** es una ciencia, que se encarga de suministrar diferentes métodos y procedimientos para recoger, clasificar, resumir, hallar regularidades y analizar los datos; así como de realizar inferencias a partir de ellos, con la finalidad de ayudar a la toma de decisiones y en su caso, formular predicciones.
</div>
...
Si procede de un conteo (discreta) y si procede de una medición  (continua).

</br></br>

### <span style="color:#034a94">**Por su relación con otras variables**</span> 

Si su comportamiento está relacionado o depende de otra variable se califica como dependiente en caso contrario se clasifica como independiente 
...
En las variables con escala de medición nominal, sus valores no se pueden ordenar, es decir que no existe una forma particular para ordenar sus valores. | Religión (católico, cristiano, evangélico, agnóstico), 
...
En estas variables el cero (0) es un valor arbitrario, no implica la ausencia de una
característica.
...
El cero (0) refleja ausencia de la característica, implica la ausencia de una característica.
