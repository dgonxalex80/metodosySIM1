...
Consiste en restar a la media de una variable a todos sus valores y diviviendo este resultado por su desviación estandar. Esta tranaformación hace que la nueva variable tenga media cero y varianza uno.
...
La estandarización en el contexto de la limpieza y ajuste de datos en ciencia de datos se refiere al proceso de transformar las variables para que tengan una media de cero y una desviación estándar de uno. Este paso es comúnmente realizado para asegurar que las variables tengan escalas comparables y para facilitar la interpretación y el análisis de los modelos.

<br/><br/>

## <span style="color:#034a94"> **Normalización**</span>

Esta transformación escala los valores de una variable a un rango específico, por defecto el rango es [0,1]. 
