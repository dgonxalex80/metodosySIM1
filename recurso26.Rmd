...
En cuanto al valor del indicador de sesgo (0.64), representa una leve simetría positiva y un valor de curtosis similar al estándar representado por la distribución normal estandar.
...
El gráfico permite visualizar una mayor cantidad de participantes en la categoría Abierta y también que la distribución de los tiempo de carrera es similar para todas las categorías. Tambien se puede observar que el dato atípico corresponde a un atleta de la categoría Veteranos C.
