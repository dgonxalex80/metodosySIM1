...
Es gran importancia determinar el tipo de escala de medición de una variable, por cuanto con ella se determina el tipo de análisis a realizar y tambien la mejera apropiada de realizar su prepresentación gráfica.
...
* Profesión (ingeniéro, estadístico, administrador,...)  
...
* Ventas mesuales de una empresa comercializadora de alimentos para mascotas
...
* Compradores de la poliza de seguro obligatorio SOAT para el 2024.  
...
* Grupo de personas que compran vehículo nuevo durante el mes de diciembre del 2023 en una determinao concesionario.
