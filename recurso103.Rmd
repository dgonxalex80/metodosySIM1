...
Estructura de datos de dos dimensiones - filas y columnas - base de datos. con la función `data()` se pueden cargar bases de datos contenidas en R.  `data(iris)` carga la base iris que contiene 150 registros (columnas) y 5 variables (filas). 
